...
<div class="pb-10">
    <div class="mt-4 pb-3 flex justify-between z-1 px-2">
        ...
        @if($is_admin)
            <button class="ml-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-flex items-center px-3 py-2 focus:outline-none transition ease-in-out duration-150"><a href="/practice-upload">{{ __('practicepage.add_practice') }}</a></button>
        @endif
    </div>
    <x-table>
        <x-table-head>
